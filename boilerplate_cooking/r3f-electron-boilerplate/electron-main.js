import {app, BrowserWindow, ipcMain, Tray, nativeImage, Menu, powerMonitor, protocol} from 'electron';
...
const createWindow = () => {
	...
	console.log(path.resolve(__dirname, '../../src/static/', '3d'));
...
app.on('ready', () => {
	...
	ipcMain.handle('getTree', (_event, path) => {
		return JSON.stringify(app.getPath(path));
	})
